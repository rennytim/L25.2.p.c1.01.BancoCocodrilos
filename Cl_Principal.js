...
const cliente1 = new Cl_Clientes("Jorge", 5000, "Cuenta 1", "", 12, "si");
const cliente2 = new Cl_Clientes("Maria", 10000, "Cuenta 2", "", 24, "no");
const cliente3 = new Cl_Clientes("Pedro", 20000, "Cuenta 3", "", 36, "si");
const cliente4 = new Cl_Clientes("Luis", 30000, "Cuenta 4", "", 48, "no");
